        ...
        <>
            <footer className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                ...
                <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start gap-2.5">
                    ...
                    <a href="https://github.com/HeartfulSky" className="text-gray-400" target="_blank" rel="noopener noreferrer">
                    ...
                    <a onClick={() => {navigator.clipboard.writeText("zack;#0997")}} className="text-gray-400 has-tooltip cursor-pointer">
                        <svg fill="currentColor" className="w-5 h-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <title>Discord</title>
                        ...
                        <span className='tooltip bg-gray-800 text-white rounded shadow-lg p-1 -mt-14'>zack;#0997</span>
                    </a>
                    ...
                    <a href="https://instagram.com/702.zackery" className="text-gray-400" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://instagram.com/702.zackery" className="text-gray-400" class="bi bi-twitch" target="_blank" rel="noopener noreferrer">
                        <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                            className="w-5 h-5" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                            <title>Instagram</title>
                            <rect width="16" height="16" x="2" y="2" rx="5" ry="5"/>
                            <path d="M3.857 0 1 2.857v10.286h3.429V16l2.857-2.857H9.57L14.714 8V0H3.857zm9.714 7.429-2.285 2.285H9l-2 2v-2H4.429V1.143h9.142v6.286z M11.857 3.143h-1.143V6.57h1.143V3.143zm-3.143 0H7.571V6.57h1.143V3.143z"/>
                       </svg>
                    </a>
                </span>
            </footer>
