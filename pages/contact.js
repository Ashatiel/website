                            ...
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: [0, 1] }} transition={{ duration: 0.5 }}>
                                ...
                                <div className="mx-auto overflow-auto mt-4">
                                    <div className="grid gap-8 px-4 md:px-0 grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
                                        <a href="mailto:sky@clumsyhosting.xyz" className="bg-gray-800 text-white p-4 text-center rounded gap-3">
                                        ...
                                        <a href="https://twitter.com/skysstw" className="bg-gray-800 text-white p-4 text-center rounded gap-3" target="_blank" rel="noopener noreferrer">
                                            ...
                                            <p className="text-white text-xl overflow-ellipsis">SkyssTW</p>
                                        </a>
                                        <a href="https://instagram.com/702.zackery" className="bg-gray-800 text-white p-4 text-center rounded gap-3" target="_blank" rel="noopener noreferrer">
                                            ...
                                            <p className="text-white text-xl overflow-ellipsis">702.zackery</p>
                                        </a>
                                    </div>
                                </div>
                            </motion.div>
