                            ...
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: [0, 1] }} transition={{ duration: 0.5 }}>
                                ...
                                <div className="container lg:w-3/5 w-11/12 mx-auto mt-4">
                                    <div className="text-left md:text-justify space-y-6 text-lg font-medium text-gray-200">
                                        ...
                                        <p>
                                            Okay, now off with the biography. I am a Twitch Streamer with over 400 followers, and I own 2 birds (Cockatiels) by the name of Apollo, and Clementine. I hope you enjoy my content and my journey with everything. <3
                                        </p>
                                    </div>
                                </div>
                            </motion.div>
