                            ...
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: [0, 1] }} transition={{ duration: 0.5 }}>
                                ...
                                <div className="container lg:w-3/5 w-11/12 mx-auto mt-4">
                                    <div className="text-left md:text-justify space-y-6 text-lg font-medium text-gray-200">
                                        ...
                                        <p>After I was pulled, something that helped me through it was Music. And honestly, I wouldn't be here today with everything that I have without Music. It helped me through a lot of stressful times, and even now I sleep to it. I know that may sound weird to you, but I grew up to it when I was 2 years old.</p>
